  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          title: Container( margin: EdgeInsets.fromLTRB(15, 20, 0, 0) ,alignment: Alignment.centerLeft, child: Text("Color Contact", style: TextStyle(fontFamily: "Cera Bold", fontSize: 25),)),
        ...
        FloatingActionButton(
          onPressed: () {
            setState(() {
              ...
              global.Contacto c1 = new global.Contacto("Andres","262626262");
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Row(
                children: <Widget>[
                  Flexible(
                      child: Center(child: ListViewContactos( notifyParent: refresh ))
                  )
                ],
              ),
            ),
                ...
                child: Center(
                  child: Container(
                    ...
                    child: ListTile(
                      ...
                      title: Text( contactos[index].nombres , style: TextStyle(color: Colors.white, fontSize: 21, fontFamily: "Cera Bold" ),),
                      subtitle: Text(contactos[index].celular, style: TextStyle(color: Colors.white ,fontSize: 18, fontFamily: "Cera Light", fontStyle: FontStyle.italic)),

                      leading: Container( width: 60, height: 60 ,child: contactos[index].imagen),

                      onTap: (){

                        Navigator.push(context,
                            MaterialPageRoute(builder: (context) => ContactoView( contactos[index])),
                        );
                ...
                children: <Widget>[
                  Container(
                    margin:EdgeInsets.fromLTRB(40, 0, 10, 0),
                      child: Text("Añadir contacto",style: TextStyle(fontSize: 21, fontFamily:"Cera Bold",color: Colors.black12 ),)
                  ),
